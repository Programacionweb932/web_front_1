    ...
    <header style={{
      ...
      <nav style={{ display: "flex", gap: "0.25rem", alignItems: "center" }}
        ...
        <Link to="/registro" style={{
          ...
          boxShadow: "0 4px 15px rgba(99,202,183,0.3)",
          transition: "all 0.2s",
        }}
      ...
      {menuOpen && (
        <div style={{
          ...
          borderBottom: "1px solid rgba(99,202,183,0.2)",
          zIndex: 999,
        }}>
...
const ImageSlider = () => {
  ...
  return (
    <div style={{ position: "relative", borderRadius: "20px", overflow: "hidden", boxShadow: "0 30px 80px rgba(0,0,0,0.5)" }}>
      ...
      {/* Arrows */}
      {[
        { dir: -1, pos: "left: 1rem", icon: <FaChevronLeft /> },
        { dir: 1, pos: "right: 1rem", icon: <FaChevronRight /> },
      ].map((a, i) => (
    ...
    <div style={{
      ...
      <div>
        ...
        <h1 style={{
          ...
          color: "#fff", lineHeight: 1.1, marginBottom: "1.5rem", margin: "0 0 1.5rem",
        }}>
          Tu aliado en{" "}
          <span style={{
            background: "linear-gradient(135deg, #63CAB7, #4A90D9)",
        ...
        <p style={{
          ...
          Mantenimiento, instalación y soporte técnico para optimizar tus equipos y mantener tu empresa siempre operativa.
        </p>
  ...
  return (
    <div ref={ref} style={{
      ...
      <p style={{
        ...
        color: "rgba(255,255,255,0.5)", lineHeight: 1.7, margin: "0 0 1.25rem",
      }}>{description}</p>
      <Link to="/login" style={{
    ...
    <section style={{ background: "#0D1120", padding: "6rem 2rem" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        <div ref={ref} style={{
          ...
          }}>Todo lo que tu empresa necesita</h2>
          <p style={{
            fontFamily: "'DM Sans', sans-serif", color: "rgba(255,255,255,0.5)",
            fontSize: "1rem", maxWidth: "500px", margin: "0 auto", lineHeight: 1.7,
          }}>Soluciones integrales de tecnología para mantener tu negocio funcionando sin interrupciones.</p>
        </div>
        <div style={{
          display: "grid",
  ...
  return (
    <div ref={ref} style={{
      ...
      <div style={{
        ...
        transition: "all 0.3s",
        boxShadow: hovered ? "0 0 25px rgba(99,202,183,0.2)" : "none",
      }}>
      ...
      <p style={{
        ...
        color: "rgba(255,255,255,0.45)", margin: "0 0 1.25rem", lineHeight: 1.6,
      }}>{description}</p>
      <button onClick={handleDownload} style={{
        ...
        transition: "all 0.2s",
        boxShadow: hovered ? "0 6px 20px rgba(99,202,183,0.35)" : "none",
      }}>
  ...
  return (
    <section style={{ background: "#0A0E1B", padding: "6rem 2rem", position: "relative", overflow: "hidden" }}>
      <div style={{
        ...
        background: "radial-gradient(ellipse, rgba(74,144,217,0.07) 0%, transparent 70%)",
        pointerEvents: "none",
      }} />
      <div style={{ maxWidth: "1200px", margin: "0 auto", position: "relative" }}>
        <div ref={ref} style={{
          ...
          <h2 style={{
            fontFamily: "'Barlow Condensed', sans-serif", fontSize: "clamp(2rem, 4vw, 3rem)",
            fontWeight: 800, color: "#fff", margin: "0 0 1rem",
          }}>Software esencial para tu equipo</h2>
          <p style={{
            fontFamily: "'DM Sans', sans-serif", color: "rgba(255,255,255,0.5)",
            fontSize: "1rem", maxWidth: "500px", margin: "0 auto", lineHeight: 1.7,
          }}>Descarga las mejores aplicaciones directamente desde aquí.</p>
        </div>
        <div style={{
          display: "grid",
    ...
    <section style={{ background: "#0D1120", padding: "6rem 2rem" }}>
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        <div ref={ref} style={{
          ...
          <span style={{
            display: "inline-block", padding: "0.3rem 1rem", borderRadius: "20px",
            border: "1px solid rgba(123,104,238,0.3)", background: "rgba(123,104,238,0.07)",
            color: "#7B68EE", fontSize: "0.8rem", fontFamily: "'DM Sans', sans-serif",
            fontWeight: 600, letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "1rem",
          }}>Testimonios</span>
          <h2 style={{
            fontFamily: "'Barlow Condensed', sans-serif", fontSize: "clamp(2rem, 4vw, 3rem)",
          ...
          {testimonials.map((t, i) => {
            ...
            return (
              <div key={i} ref={cardRef} style={{
                ...
                borderRadius: "16px", padding: "2rem",
                opacity: cardInView ? 1 : 0, transform: cardInView ? "none" : "translateY(25px)",
                transition: `all 0.5s ${i * 0.1}s`,
              }}>
                <div style={{ display: "flex", gap: "0.25rem", marginBottom: "1rem" }}>
                  {Array(t.stars).fill(0).map((_, si) => (
                    <FaStar key={si} style={{ color: "#F59E0B", fontSize: "0.9rem" }} />
                  ))}
                </div>
                <p style={{
                  fontFamily: "'DM Sans', sans-serif", fontSize: "0.96rem",
                  color: "rgba(255,255,255,0.7)", lineHeight: 1.75, fontStyle: "italic",
                  margin: "0 0 1.5rem",
                }}>"{t.text}"</p>
                <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
                  <div style={{
  ...
  return (
    <section style={{ background: "#0A0E1B", padding: "6rem 2rem" }}>
      <div ref={ref} style={{
        ...
        border: "1px solid rgba(99,202,183,0.2)", borderRadius: "24px",
        padding: "4rem 2rem",
        ...
        <h2 style={{
          fontFamily: "'Barlow Condensed', sans-serif", fontSize: "clamp(1.8rem, 4vw, 2.8rem)",
          fontWeight: 800, color: "#fff", margin: "0 0 1rem", lineHeight: 1.2,
        }}>¿Listo para optimizar tu<br />experiencia tecnológica?</h2>
        <p style={{
          fontFamily: "'DM Sans', sans-serif", color: "rgba(255,255,255,0.55)",
          fontSize: "1rem", maxWidth: "450px", margin: "0 auto 2rem", lineHeight: 1.7,
        }}>Únete a cientos de clientes que ya confían en nosotros para su soporte tecnológico.</p>
...
const Footer = () => (
  <footer style={{
    background: "#060810", borderTop: "1px solid rgba(255,255,255,0.06)",
    padding: "2.5rem 2rem",
  }}>
    <div style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
        ...
        <div>
          <div style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, color: "#fff", fontSize: "0.95rem" }}>
          ...
          <div style={{ fontFamily: "'DM Sans', sans-serif", fontSize: "0.72rem", color: "rgba(255,255,255,0.3)" }}>
            ...
            <a href="https://mi-cv-juan-granja.vercel.app/" target="_blank" rel="noreferrer"
              style={{ color: "#63CAB7", textDecoration: "none" }}>Juan Granja</a>
          </div>
        </div>
      </div>
...
const GlobalStyles = () => (
  <style>{`
    ...
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* Elimina cualquier fondo blanco de clases heredadas */
    ...
    /* Particles canvas si quedó del código anterior */
